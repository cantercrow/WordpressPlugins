 ...
 * Description:       This is a test plugin template
 * Version:           1.0.0
 ...
 */
function deactivate_test plugin() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-test plugin-deactivator.php';
	Test_Plugin_Deactivator::deactivate();
}

register_activation_hook( __FILE__, 'activate_test plugin' );
register_deactivation_hook( __FILE__, 'deactivate_test plugin' );
